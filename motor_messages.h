...
typedef MOTOR_STATUS_REGULAR MotorStatusRegular;
typedef struct {
...
typedef enum {SINE, SQUARE, TRIANGLE, CHIRP, RANDOM} TuningMode;

typedef struct {
    float current_desired;              // \sa MotorCommand
